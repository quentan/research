...
class CloneVolume(ScriptedLoadableModule):

    def __init__(self, parent):
        ScriptedLoadableModule.__init__(self, parent)

        self.parent.title = 'CloneVolume'
...
class CloneVolumeWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        pgCoBtn.text = "CloneVolume Collasible Button"
