...
# Have not figured out how to use this module.
...
class VolumeMaskerWidget:
    ...
    def setup(self):
        ...
        self.inputVolumeSelectorLabel = qt.QLabel(
            "Input Volume: ", self.inputVolumeSelectorFrame)
        ...
        self.inputVolumeSelectorFrame.layout().addWidget(
            self.inputVolumeSelectorLabel)

        self.inputVolumeSelector = slicer.qMRMLNodeComboBox(
            self.inputVolumeSelectorFrame)
        self.inputVolumeSelector.nodeTypes = (("vtkMRMLScalarVolumeNode"), "")
        self.inputVolumeSelector.addAttribute(
        ...
        self.labelSelector.addAttribute(
            "vtkMRMLScalarVolumeNode", "LabelMap", "1")
        ...
        self.outputVolumeSelectorFrame.layout().addWidget(
            self.outputVolumeSelectorLabel)
